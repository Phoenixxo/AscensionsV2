...
public class RebirthTabCompleter implements TabCompleter {

    private static final List<String> SUBCOMMANDS = Arrays.asList("gui", "reload", "level");

    private static final List<String> GUI_SUBS = Arrays.asList("rebirth", "perks");
    ...
    public @Nullable List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String s, @NotNull String[] args) {
        ...
        if (args.length == 2 && args[0].equalsIgnoreCase("level")) {
            ...
            return StringUtil.copyPartialMatches(args[1], GUI_SUBS, new ArrayList<>());
        }
